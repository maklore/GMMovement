...
function __GMMDebug(_enable) {
	...
	dbg_view("GMMovement", _enable);
		...
		dbg_section("Grid", true);
			...
			dbg_text(" grid_path_running:                 "); dbg_same_line(); dbg_text(ref_create(__GMMConfig(), "grid_path_running"));
			dbg_text(" grid_path_active:                  "); dbg_same_line(); dbg_text(ref_create(__GMMConfig(), "grid_path_active"));
